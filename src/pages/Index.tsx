    ...
    <>
      ...
      <main className="h-screen overflow-y-auto snap-y snap-mandatory relative">
        ...
        <section className="h-screen snap-start flex flex-col relative shrink-0">
          {/* Logo - Top Left */}
          <div className="absolute md:-top-4 md:-left-8 -left-4 -top-4 pt-16">
            <Logo className="h-64" />
          </div>
        ...
        >
          ...
          <div className="flex-1 flex items-center flex-col lg:space-y-8 space-y-6 justify-center px-6 md:px-12 mt-[-100px]">
            ...
            <h3 className="uppercase font-bold tracking-wide text-md md:text-xl lg:text-3xl">
              Now Live: Decision Logs
            </h3>
          </div>

          <div className="absolute bottom-12 left-1/2 -translate-x-1/2 w-full px-4">
            <div className="mx-auto flex flex-col sm:flex-row max-w-lg items-center gap-3 justify-center">
              <Link
                to="/problems"
                className="rounded-full px-6 py-3 text-sm font-medium text-black bg-white hover:bg-white/90 transition"
              >
                View Problems
              </Link>
              <Link
                to="/engineers"
                className="rounded-full px-6 py-3 text-sm font-medium text-foreground border border-white/20 hover:bg-white/10 transition"
              >
                For Engineers
              </Link>
              <Link
